...
{
    public class SqlMultiFileSystemHistoryServiceTest : SqlTestBase
    {
        ...
        public SqlMultiFileSystemHistoryServiceTest()
        {
            ...
            var multiFileSystemSnapshotRepository = new MultiFileSystemSnapshotRepository(Database);

            var sqlFileSystemFactory = new Mock<ISqlFileSystemFactory>(MockBehavior.Strict);
            ...
            groupMock.Setup(g => g.GetService<IConfigurationService>()).Returns(Mock.Of<IConfigurationService>());
            m_Group = groupMock.Object;            
        }
